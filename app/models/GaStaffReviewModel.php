...
class GaStaffReviewModel
{
    ...
    public function forwardToPresident(int $reportId, string $reviewedBy, string $notes): void
    {
        db_execute(
    ...
    public function returnToSecurity(int $reportId, string $reviewedBy, string $notes): void
    {
        db_execute(
