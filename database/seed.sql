...
--
-- GA Manager (role: ga_manager)
--   k.enriquez      / Password123! -- Karen F. Enriquez    (GA Manager, id: 0300553)
--
-- GA Staff (role: ga_staff)
--   l.acosta        / Password123! -- Liza Acosta          (GA Staff, id: 0401157)
--   c.buenconsejo   / Password123! -- Cherry N. Buenconsejo (GA Staff, id: 1200385)
--
...
INSERT INTO users (id, name, username, password_hash, role, department_id, security_type, building, account_status, created_by_role, created_by_user_id, created_at) VALUES
  (0300553, 'Karen F. Enriquez', 'k.enriquez',  @PWD, 'ga_manager', NULL, NULL, NULL, 'active', 'system',      NULL, '2026-01-15 09:00:00'),
  (0401157, 'Liza Acosta', 'l.acosta',  @PWD, 'ga_staff',     NULL, NULL, NULL, 'active', 'system',      0300553, '2026-01-15 09:05:00'),
  (1200385, 'Cherry Novelyn Buenconsejo', 'c.buenconsejo',   @PWD, 'ga_staff',     NULL, NULL, NULL, 'active', 'ga_president',   0300553, '2026-01-15 09:10:00');

-- PICs (Person-In-Charge per department)
INSERT INTO users (id, name, username, password_hash, role, department_id, security_type, building, account_status, created_by_role, created_by_user_id, created_at) VALUES
  (4, 'Ana Mendoza',       'a.mendoza',    @PWD, 'pic', 1, NULL, NULL, 'active', 'ga_staff', 0300553, '2026-01-15 09:20:00'),
  (5, 'Carlos Bautista',   'c.bautista',   @PWD, 'pic', 2, NULL, NULL, 'active', 'ga_staff', 0300553, '2026-01-15 09:21:00'),
  (6, 'Elena Cruz',        'e.cruz',       @PWD, 'pic', 3, NULL, NULL, 'active', 'ga_staff', 0401157, '2026-01-15 09:22:00'),
  (7, 'Roberto Villanueva','r.villanueva', @PWD, 'pic', 4, NULL, NULL, 'active', 'ga_staff', 0401157, '2026-01-15 09:23:00'),
  (8, 'Maricel Torres',    'm.torres',     @PWD, 'pic', 5, NULL, NULL, 'active', 'ga_staff', 1200385, '2026-01-15 09:24:00');

-- Security officers
INSERT INTO users (id, name, username, password_hash, role, department_id, security_type, building, account_status, created_by_role, created_by_user_id, created_at) VALUES
  (8810183,  'Benjamin D. Esteban',    'b.esteban',   @PWD, 'security', NULL, 'external', 'NCFL', 'active', 'ga_staff', 0300553, '2026-01-15 09:30:00'),
  (8810305, 'Efren M. Corrales',       'e.corrales',    @PWD, 'security', NULL, 'internal', 'NCFL', 'active', 'ga_staff', 0300553, '2026-01-15 09:31:00'),
  (8810279, 'Christian Provido',   'c.provido',  @PWD, 'security', NULL, 'internal', 'NPFL', 'active', 'ga_staff', 0401157, '2026-01-15 09:32:00'),
  (8810222, 'Jayson Ruazol', 'j.ruazol', @PWD, 'security', NULL, 'external', 'NPFL', 'active', 'ga_staff', 0401157, '2026-01-15 09:33:00');
...
(10, 'SR-2026-0010', 'HVAC Failure in Server Room',      'Environmental', 'NCFL Server Room A1',        'critical', 'NCFL', 2, 'HVAC unit shutdown; server room reached 38°C. Equipment auto-shutdown triggered.', 'Portable cooler deployed; servers back online.',          'Replace HVAC unit before next heatwave.',         8810305, '2026-02-25 09:30:00', 'ga_president', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'submitted_to_ga_president', '2026-02-25 15:30:00'),
...
-- Reviewed alternately by l.acosta (0401157) and c.buenconsejo (1200385).
-- All forwarded to GA President.
-- ==================================================================
INSERT INTO ga_staff_reviews (id, report_id, reviewed_by, decision, notes, reviewed_at) VALUES
  (1,  9,  0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-25 12:00:00'),
  (2,  10, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-25 13:30:00'),
  (3,  11, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-24 14:00:00'),
  (4,  12, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-24 15:30:00'),
  (5,  13, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-23 12:45:00'),
  (6,  14, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-23 16:00:00'),
  (7,  15, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-22 13:00:00'),
  (8,  16, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-22 14:30:00'),
  (9,  17, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-22 15:00:00'),
  (10, 18, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-21 17:00:00'),
  (11, 19, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-21 20:00:00'),
  (12, 20, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-20 10:00:00'),
  (13, 21, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-20 20:00:00'),
  (14, 22, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-19 11:00:00'),
  (15, 23, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-19 12:30:00'),
  (16, 24, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-18 10:00:00'),
  (17, 25, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-18 13:00:00'),
  (18, 26, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-17 16:00:00'),
  (19, 27, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-17 11:00:00'),
  (20, 28, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-15 10:00:00'),
  (21, 29, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-15 11:00:00'),
  (22, 30, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-14 09:30:00'),
  (23, 31, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-13 10:00:00'),
  (24, 32, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-12 12:00:00'),
  (25, 33, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-10 10:00:00'),
  (26, 34, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-09 11:30:00'),
  (27, 35, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-08 13:00:00'),
  (28, 36, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-07 15:00:00'),
  (29, 37, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-05 10:00:00'),
  (30, 38, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-04 11:00:00'),
  (31, 39, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-04 12:30:00'),
  (32, 40, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-03 15:00:00'),
  (33, 41, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-02-02 09:00:00'),
  (34, 42, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-02-01 08:00:00'),
  (35, 43, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-01-30 13:00:00'),
  (36, 44, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-01-29 11:00:00'),
  (37, 45, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-01-29 00:00:00'),
  (38, 46, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-01-28 09:00:00'),
  (39, 47, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-01-27 12:00:00'),
  (40, 48, 1200385, 'forwarded', 'Reviewed and forwarded.', '2026-01-26 16:00:00'),
  (41, 49, 0401157, 'forwarded', 'Reviewed and forwarded.', '2026-01-25 11:00:00'),
...
INSERT INTO ga_president_approvals (id, report_id, decided_by, decision, notes, decided_at) VALUES
  (1,  15, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-22 15:00:00'),
  (2,  16, 0300553, 'approved', 'Approved; assign to IT.',          '2026-02-22 16:30:00'),
  (3,  17, 0300553, 'approved', 'Approved; assign to Operations.',  '2026-02-22 17:30:00'),
  (4,  18, 0300553, 'approved', 'Approved; assign to Operations.',  '2026-02-21 21:00:00'),
  (5,  19, 0300553, 'approved', 'Approved; assign to HR.',          '2026-02-21 22:30:00'),
  (6,  20, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-20 12:00:00'),
  (7,  21, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-20 22:00:00'),
  (8,  22, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-19 13:00:00'),
  (9,  23, 0300553, 'approved', 'Approved; assign to IT.',         '2026-02-19 14:30:00'),
  (10, 24, 0300553, 'approved', 'Approved; assign to Operations.', '2026-02-18 12:00:00'),
  (11, 25, 0300553, 'approved', 'Approved; assign to Operations.', '2026-02-18 15:00:00'),
  (12, 26, 0300553, 'approved', 'Approved; assign to QA.',         '2026-02-17 17:30:00'),
  (13, 27, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-17 13:00:00'),
  (14, 28, 0300553, 'approved', 'Approved; assign to IT.',         '2026-02-15 12:00:00'),
  (15, 29, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-15 13:00:00'),
  (16, 30, 0300553, 'approved', 'Approved; assign to QA.',         '2026-02-14 11:30:00'),
  (17, 31, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-13 12:00:00'),
  (18, 32, 0300553, 'approved', 'Approved; assign to IT.',         '2026-02-12 14:00:00'),
  (19, 33, 0300553, 'approved', 'Approved; assign to IT.',         '2026-02-10 12:00:00'),
  (20, 34, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-09 13:30:00'),
  (21, 35, 0300553, 'approved', 'Approved; assign to Operations.', '2026-02-08 15:00:00'),
  (22, 36, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-07 17:00:00'),
  (23, 37, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-05 12:00:00'),
  (24, 38, 0300553, 'approved', 'Approved; assign to QA.',         '2026-02-04 13:00:00'),
  (25, 39, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-04 14:30:00'),
  (26, 40, 0300553, 'approved', 'Approved; assign to IT.',         '2026-02-03 17:00:00'),
  (27, 41, 0300553, 'approved', 'Approved; assign to QA.',         '2026-02-02 11:00:00'),
  (28, 42, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-02-01 10:00:00'),
  (29, 43, 0300553, 'approved', 'Approved; assign to Operations.', '2026-01-30 15:00:00'),
  (30, 44, 0300553, 'approved', 'Approved; assign to Facilities.', '2026-01-29 13:00:00'),
  (31, 45, 0300553, 'approved', 'Approved; assign to IT.',         '2026-01-29 02:00:00'),
  (32, 46, 0300553, 'approved', 'Approved; assign to Operations.', '2026-01-28 11:00:00'),
  (33, 47, 0300553, 'rejected', 'Not within scope of security reporting. Handle via FM ticket.', '2026-01-28 14:00:00'),
  (34, 48, 0300553, 'rejected', 'Cosmetic issue; not a security concern. Close and handle internally.', '2026-01-27 11:00:00'),
  (35, 49, 0300553, 'rejected', 'Procedural filing issue belongs in QA system, not security reports.', '2026-01-26 10:00:00'),
  (36, 50, 0300553, 'rejected', 'Personnel dispute; refer to HR. Not a security incident.', '2026-01-26 11:00:00');
...
INSERT INTO security_final_checks (id, report_id, decision, remarks, checked_by, checked_at, closed_at) VALUES
  (1,  33, 'returned',  'Log gaps still present in verification test run.',                    8810279, '2026-02-28 10:00:00', NULL),
  ...
  (4,  36, 'returned',  'Oil leak resumed within 48 hours of seal fix.',                        8810183, '2026-03-02 11:00:00', NULL),
  (5,  37, 'confirmed', 'New glass verified; frame seal inspected.',                           8810279, '2026-02-17 10:00:00', '2026-02-17 10:00:00'),
  (6,  38, 'confirmed', 'Drill attendance records sighted and signed off.',                     8810183, '2026-02-14 11:00:00', '2026-02-14 11:00:00'),
  ...
  (9,  41, 'confirmed', 'Remediation photos reviewed; agency receipt confirmed.',              8810279, '2026-02-10 10:00:00', '2026-02-10 10:00:00'),
  (10, 42, 'confirmed', 'Fence panel installed; padlocked inspection cover confirmed.',         8810183, '2026-02-09 14:00:00', '2026-02-09 14:00:00'),
  ...
  (13, 45, 'confirmed', 'Mantrap operational; access log clean; police report filed.',        8810279, '2026-02-04 10:00:00', '2026-02-04 10:00:00'),
  (14, 46, 'confirmed', 'New valve certified; sensor alarm tested at 10% LEL.',                8810183, '2026-02-03 12:00:00', '2026-02-03 12:00:00');
...
INSERT INTO report_status_history (report_id, status, changed_by, notes, changed_at) VALUES
  ...
  (1,  'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-03-01 07:15:00'),
  (2,  'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-03-01 09:30:00'),
  ...
  (6,  'submitted_to_ga_staff',    8810222,  'Submitted by Security.',                           '2026-02-28 10:20:00'),
  (7,  'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-27 14:10:00'),
  (8,  'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-27 16:00:00'),
  -- Reports 9â€“14: submitted â†’ forwarded to president
  (9,  'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-25 08:00:00'),
  (9,  'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-25 12:00:00'),
  (10, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-25 09:30:00'),
  (10, 'submitted_to_ga_president', 1200385,  'Forwarded to GA President.',                       '2026-02-25 13:30:00'),
  (11, 'submitted_to_ga_staff',    8810305,  'Submitted by Security.',                           '2026-02-24 10:00:00'),
  (11, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-24 14:00:00'),
  ...
  (13, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-23 08:45:00'),
  (13, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-23 12:45:00'),
  ...
  (15, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-22 13:00:00'),
  (15, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-22 15:00:00'),
  (16, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-22 09:15:00'),
  (16, 'submitted_to_ga_president', 1200385,  'Forwarded to GA President.',                       '2026-02-22 14:30:00'),
  (16, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-22 16:30:00'),
  (17, 'submitted_to_ga_staff',    8810305,  'Submitted by Security.',                           '2026-02-22 11:00:00'),
  (17, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-22 15:00:00'),
  (17, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-02-22 17:30:00'),
  (18, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-21 14:00:00'),
  (18, 'submitted_to_ga_president', 1200385,  'Forwarded to GA President.',                       '2026-02-21 17:00:00'),
  (18, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-02-21 21:00:00'),
  (19, 'submitted_to_ga_staff',    8810305,  'Submitted by Security.',                           '2026-02-21 16:30:00'),
  (19, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-02-21 20:00:00'),
  (19, 'sent_to_department',        0300553,  'Approved and sent to HR.',                         '2026-02-21 22:30:00'),
  -- Reports 20â€“27: â†’ under_department_fix
  (20, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-20 06:30:00'),
  (20, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-20 12:00:00'),
  (20, 'under_department_fix',      4,  'Fix timeline set: 16 day(s).',                     '2026-02-21 09:00:00'),
  (21, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-20 18:00:00'),
  (21, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-20 22:00:00'),
  (21, 'under_department_fix',      4,  'Fix timeline set: 18 day(s).',                     '2026-02-21 10:00:00'),
  (22, 'submitted_to_ga_staff',    8810305,  'Submitted by Security.',                           '2026-02-19 09:00:00'),
  (22, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-19 13:00:00'),
  ...
  (23, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-19 14:30:00'),
  (23, 'under_department_fix',      5,  'Fix timeline set: 20 day(s).',                     '2026-02-20 11:00:00'),
  (24, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-18 08:00:00'),
  (24, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-02-18 12:00:00'),
  (24, 'under_department_fix',      7,  'Fix timeline set: 15 day(s).',                     '2026-02-19 09:00:00'),
  (25, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-18 11:00:00'),
  (25, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-02-18 15:00:00'),
  ...
  (26, 'sent_to_department',        0300553,  'Approved and sent to QA.',                         '2026-02-17 17:30:00'),
  ...
  (27, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-17 13:00:00'),
  (27, 'under_department_fix',      4,  'Fix timeline set: 30 day(s).',                     '2026-02-18 11:00:00'),
  -- Reports 28â€“32: â†’ for_security_final_check
  (28, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-15 08:00:00'),
  (28, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-15 12:00:00'),
  (28, 'for_security_final_check',  5,  'Marked as DONE by Department.',                    '2026-02-22 13:00:00'),
  (29, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-15 09:00:00'),
  (29, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-15 13:00:00'),
  ...
  (30, 'sent_to_department',        0300553,  'Approved and sent to QA.',                         '2026-02-14 11:30:00'),
  ...
  (31, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-13 12:00:00'),
  (31, 'for_security_final_check',  4,  'Marked as DONE by Department.',                    '2026-02-20 08:00:00'),
  (32, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-12 10:00:00'),
  (32, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-12 14:00:00'),
  (32, 'for_security_final_check',  5,  'Marked as DONE by Department.',                    '2026-02-19 11:00:00'),
  -- Reports 33â€“36: â†’ returned_to_department
  (33, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-10 08:00:00'),
  (33, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-10 12:00:00'),
  (33, 'for_security_final_check',  5,  'Marked as DONE by Department.',                    '2026-02-25 14:00:00'),
  (33, 'returned_to_department',   8810279,  'Log gaps still present in verification.',          '2026-02-28 10:00:00'),
  (34, 'submitted_to_ga_staff',    8810305,  'Submitted by Security.',                           '2026-02-09 09:30:00'),
  (34, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-09 13:30:00'),
  ...
  (35, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-02-08 15:00:00'),
  ...
  (36, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-07 13:00:00'),
  (36, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-07 17:00:00'),
  (36, 'for_security_final_check',  4,  'Marked as DONE by Department.',                    '2026-02-29 10:00:00'),
  (36, 'returned_to_department',    8810183,  'Oil leak resumed after seal fix.',                 '2026-03-02 11:00:00'),
  -- Reports 37â€“46: â†’ resolved
  (37, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-05 08:00:00'),
  (37, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-05 12:00:00'),
  (37, 'for_security_final_check',  4,  'Marked as DONE by Department.',                    '2026-02-14 10:00:00'),
  (37, 'resolved',                 8810279,  'Security confirmed and closed.',                   '2026-02-17 10:00:00'),
  (38, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-04 09:00:00'),
  (38, 'sent_to_department',        0300553,  'Approved and sent to QA.',                         '2026-02-04 13:00:00'),
  (38, 'for_security_final_check',  8,  'Marked as DONE by Department.',                    '2026-02-12 17:00:00'),
  (38, 'resolved',                  8810183,  'Security confirmed and closed.',                   '2026-02-14 11:00:00'),
  (39, 'submitted_to_ga_staff',    8810222,  'Submitted by Security.',                           '2026-02-04 10:30:00'),
  (39, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-04 14:30:00'),
  ...
  (40, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-02-03 17:00:00'),
  ...
  (41, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-02-02 07:30:00'),
  (41, 'sent_to_department',        0300553,  'Approved and sent to QA.',                         '2026-02-02 11:00:00'),
  (41, 'for_security_final_check',  8,  'Marked as DONE by Department.',                    '2026-02-08 09:00:00'),
  (41, 'resolved',                 8810279,  'Security confirmed and closed.',                   '2026-02-10 10:00:00'),
  (42, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-02-01 06:00:00'),
  (42, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-02-01 10:00:00'),
  (42, 'for_security_final_check',  4,  'Marked as DONE by Department.',                    '2026-02-07 13:00:00'),
  (42, 'resolved',                  8810183,  'Security confirmed and closed.',                   '2026-02-09 14:00:00'),
  (43, 'submitted_to_ga_staff',    8810222,  'Submitted by Security.',                           '2026-01-30 11:00:00'),
  (43, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-01-30 15:00:00'),
  ...
  (44, 'sent_to_department',        0300553,  'Approved and sent to Facilities.',                 '2026-01-29 13:00:00'),
  ...
  (45, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-01-28 22:00:00'),
  (45, 'sent_to_department',        0300553,  'Approved and sent to IT.',                         '2026-01-29 02:00:00'),
  (45, 'for_security_final_check',  5,  'Marked as DONE by Department.',                    '2026-02-03 09:00:00'),
  (45, 'resolved',                 8810279,  'Security confirmed and closed.',                   '2026-02-04 10:00:00'),
  (46, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-01-28 07:00:00'),
  (46, 'sent_to_department',        0300553,  'Approved and sent to Operations.',                 '2026-01-28 11:00:00'),
  (46, 'for_security_final_check',  7,  'Marked as DONE by Department.',                    '2026-02-02 11:00:00'),
  (46, 'resolved',                  8810183,  'Security confirmed and closed.',                   '2026-02-03 12:00:00'),
  -- Reports 47â€“50: â†’ rejected
  (47, 'submitted_to_ga_staff',    8810222,  'Submitted by Security.',                           '2026-01-27 10:00:00'),
  (47, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-01-27 12:00:00'),
  (47, 'rejected',                  0300553,  'Not within scope; rejected by GA President.',      '2026-01-28 14:00:00'),
  ...
  (48, 'rejected',                  0300553,  'Cosmetic issue; rejected by GA President.',        '2026-01-27 11:00:00'),
  (49, 'submitted_to_ga_staff',    8810279,  'Submitted by Security.',                           '2026-01-25 09:00:00'),
  (49, 'submitted_to_ga_president', 0401157,  'Forwarded to GA President.',                       '2026-01-25 11:00:00'),
  (49, 'rejected',                  0300553,  'QA procedural issue; rejected by GA President.',   '2026-01-26 10:00:00'),
  (50, 'submitted_to_ga_staff',     8810183,  'Submitted by Security.',                           '2026-01-25 11:00:00'),
  (50, 'submitted_to_ga_president', 1200385,  'Forwarded to GA President.',                       '2026-01-25 13:00:00'),
  (50, 'rejected',                  0300553,  'Personnel dispute; rejected by GA President.',     '2026-01-26 11:00:00');
...
INSERT INTO notifications (user_id, report_id, message, is_read, created_at) VALUES
  ...
  (0401157,  1,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 07:16:00'),
  (1200385,  1,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 07:16:00'),
  (0401157,  2,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 09:31:00'),
  (1200385,  2,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 09:31:00'),
  (0401157,  3,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 11:01:00'),
  (1200385,  3,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 11:01:00'),
  (0401157,  4,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 13:46:00'),
  (1200385,  4,  'New Report Submitted and Waiting for Review',                            0, '2026-03-01 13:46:00'),
  (0401157,  5,  'New Report Submitted and Waiting for Review',                            0, '2026-02-28 08:01:00'),
  (1200385,  5,  'New Report Submitted and Waiting for Review',                            0, '2026-02-28 08:01:00'),
  (0401157,  6,  'New Report Submitted and Waiting for Review',                            0, '2026-02-28 10:21:00'),
  (1200385,  6,  'New Report Submitted and Waiting for Review',                            0, '2026-02-28 10:21:00'),
  (0401157,  7,  'New Report Submitted and Waiting for Review',                            0, '2026-02-27 14:11:00'),
  (1200385,  7,  'New Report Submitted and Waiting for Review',                            0, '2026-02-27 14:11:00'),
  (0401157,  8,  'New Report Submitted and Waiting for Review',                            0, '2026-02-27 16:01:00'),
  (1200385,  8,  'New Report Submitted and Waiting for Review',                            0, '2026-02-27 16:01:00'),
  -- GA President notified of 6 pending decisions
  (0300553,  9,  'Report Waiting for Final GA Approval',                                   0, '2026-02-25 12:01:00'),
  (0300553,  10, 'Report Waiting for Final GA Approval',                                   0, '2026-02-25 13:31:00'),
  (0300553,  11, 'Report Waiting for Final GA Approval',                                   0, '2026-02-24 14:01:00'),
  (0300553,  12, 'Report Waiting for Final GA Approval',                                   0, '2026-02-24 15:31:00'),
  (0300553,  13, 'Report Waiting for Final GA Approval',                                   0, '2026-02-23 12:46:00'),
  (0300553,  14, 'Report Waiting for Final GA Approval',                                   0, '2026-02-23 16:01:00'),
  ...
  (8810183,  20, 'Department Set Fix Timeline. Due: Feb 08, 2026',                          1, '2026-02-21 09:01:00'),
  (8810279, 21, 'Department Set Fix Timeline. Due: Mar 10, 2026',                          0, '2026-02-21 10:01:00'),
  (8810305, 22, 'Department Set Fix Timeline. Due: Mar 15, 2026',                          0, '2026-02-20 10:01:00'),
  (8810222, 23, 'Department Set Fix Timeline. Due: Mar 12, 2026',                          0, '2026-02-20 11:01:00'),
  (8810183,  24, 'Department Set Fix Timeline. Due: Mar 06, 2026',                          0, '2026-02-19 09:01:00'),
  (8810279, 25, 'Department Set Fix Timeline. Due: Mar 05, 2026',                          0, '2026-02-19 12:01:00'),
  ...
  (8810183,  28, 'Department Marked Report as Fixed. Please Verify',                        0, '2026-02-22 13:01:00'),
  (8810279, 29, 'Department Marked Report as Fixed. Please Verify',                        0, '2026-02-22 15:01:00'),
  ...
  (8810183,  32, 'Department Marked Report as Fixed. Please Verify',                        0, '2026-02-19 11:01:00'),
  ...
  (8810183,  9,  'Report Approved by GA President. Assigned to Department for Resolution',  1, '2026-02-25 15:01:00'),
  (8810183,  10, 'Report Approved by GA President. Assigned to Department for Resolution',  1, '2026-02-25 15:01:00');
